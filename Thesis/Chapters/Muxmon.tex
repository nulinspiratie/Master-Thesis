...
\part{Muxmon experiment}
  ...
  \chapter{Exploring frequency re-use}
    ...
    \section{Duplexer}
      \label{sec:Duplexer}
      The Duplexer is a patented vector switch matrix designed by Duije Deurloo, who is working at TNO. It has four input ports and two ouput ports. Each of the input-output port combinations has the following successive components:
      ...
      The Duplexer's digital switches have an RF-switching time of \SI{4}{\nano \second}. Using these switches, pulses may be sent to either of the two qubits, or to both qubits simultaneously. This allows for selective broadcasting

      \textbf{Figures:}
      \begin{itemize}
        \item Figure of Duplexer
      \end{itemize}
    ...
    \begin{itemize}
      ...
      \item More coupling between qubits in Muxmon1
      \item Also show cross-coupling of Muxmon1 in Appendix
    \end{itemize}
