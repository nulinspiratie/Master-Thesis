...
\part{Muxmon experiment}
  ...
  \chapter{Calibration routines}
    ...
    \section{Drive amplitude calibration}
      To test the limits of performance using the Duplexer all gates need to be calibrated to a very high accuracy. The Rabi measurement explained in section

      \begin{itemize}
        \item High fidelity gates required
