  ...
  \chapter{Qubit characterization}
    ...
    \section{Continuous-wave measurements}
      ...
      \subsection{Tracking the qubits}
        ...
        For more information on the tracked spectroscopy algorithm see appendix~\ref{A-sec:Tracked spectroscopy}.
    ...
    \section{Time-domain measurements}
      ...
      \subsection{Qubit relaxation}
        Once a pi-pulse has been tuned it is possible to excite the qubit. However, once the qubit is excited, it will not remain so indefinitely. Instead, the excitation will slowly leak away
