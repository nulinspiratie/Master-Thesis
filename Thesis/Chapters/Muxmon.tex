  ...
  \chapter{Muxmon chip architecture}
    ...
    \begin{itemize}
      ...
      \begin{itemize}
        ...
        \item Air bridges are used, not only to connect the ground planes, but also such that the feed line can pass over other coplanar waveguides without contact \\
      \end{itemize}
