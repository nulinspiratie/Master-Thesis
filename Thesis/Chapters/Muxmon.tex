...
\chapter{Muxmon chip architecture}
  ...
  \section{Direct driving versus capacitive driving}
    ...
    To study frequency re-use two chips were created, the Muxmon0 and the Muxmon 1. Both chips have three transmon qubits connected to them, are flux-tunable
