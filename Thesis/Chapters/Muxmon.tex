...
\part{Muxmon experiment}
  ...
  \chapter{Exploring frequency re-use}
    ...
    \section{Properties of the Muxmon0 chip}
      ...
      In the Muxmon0 chip the top and bottom qubits are coupled to the ancilla qubit via a resonator bus.

      \textbf{TODO:}
      \begin{itemize}
        \item explain top ancilla and bottom qubit
        \item Add third decimal top and ancilla qubit frequencies
      \end{itemize}
