...
\chapter{Theory}
  ...
  \section{Quality factor}
    ...
    \end{equation}
    Here $\omega_0$ is the resonance frequency of the resonator, $\Delta \omega$ is the full width at half maximum, and $\tau_1$ is the decay time of the resonator. The decay time is the time after which the energy of a resonator is dissipated to $1/e$ of its original value.
    ...
    where $\kappa=\omega_0/Q_i$ is the cavity decay rate.
