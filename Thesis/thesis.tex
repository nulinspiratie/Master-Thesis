...
\HRule{0.5 pt} \\
\LARGE \textbf{Exploring frequency reuse with transmon qubits in a cQED architecture}
\HRule{2 pt} \\ [0.5 cm]
...
\begin{center}
    \Large
    \textbf{Exploring frequency reuse with transmon qubits in a cQED architecture}
