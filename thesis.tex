  ...
  \chapter{Qubit characterization}
    ...
    \section{Part I: Continuous-wave measurements}
      ...
      \subsection{Scanning for qubits}
        ...
        The measurement to perform in order to find the qubit depends on the amount of detuning between the resonator and qubit. If the amount of detuning is small (less than $\pm \SI{100}{\mega \hertz}$), the frequencies of the qubit and resonator are close to the avoided crossing. The resonator and qubit are strongly coupled. In this case one should use a single-tone measurement. If the detuning between the resonator and qubit is sufficiently large
