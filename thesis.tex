    ...
    \section{Part I: Continuous-wave measurements}
      ...
      \subsection{Scanning for resonators}
        ...
        \begin{itemize}
          ...
          \item Explain that the quality factor is low because the resonator is coupled strongly to the qubit
        \end{itemize}
      ...
      \subsection{Powersweeping the resonators}
        ...
        A powersweep additionally provides information about at what power the resonator enters the \textbf{TODO:} nonlinear? regime. For measurements involving the qubit the readout power must be below this threshold power.

        \textbf{TODO:}
        \begin{itemize}
          \item Explain better theory behind resonator shift $\chi$
          \item Explain theory behind transition to bare cavity frequency
          \item Refer to thesis for more info on frequency shifts
        \end{itemize}
